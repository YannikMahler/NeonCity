...
public class ModBlocks {
    ...
    public static final Block BLUE_NEON_LAMP = registerBlocks("blue_neon_lamp",
            new Block(FabricBlockSettings.copy(Blocks.SEA_LANTERN)));
    ...
    public static final Block BLUE_BUTTON = registerBlocks("blue_button",
            new ButtonBlock(FabricBlockSettings.copy(Blocks.POLISHED_BLACKSTONE_BUTTON),BlockSetType.IRON, 10, true));
    ...
    public static final Block YELLOW_BUTTON = registerBlocks("yellow_button",
            new ButtonBlock(FabricBlockSettings.copy(Blocks.LANTERN),BlockSetType.IRON, 10, true));
